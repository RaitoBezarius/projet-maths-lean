...
\paragraph{Niveau 4} :  \texttt{mul\_add}  \begin{center} La multiplication est distributive, c'est à dire  $\forall a, b, t \in \mathbb{N},$  $t\times(a+b)=t\times a+t\times b $ \end{center}
