...
On a démontré que :
\begin{minted}[mathescape=true,linenos,numbersep=5pt,frame=lines,framesep=2mm,breaklines,escapeinside=||]{lean}
...
\begin{equation*}
    a < b \equiv a \leq b \land \lnot (b \leq a)
\end{equation*}

Mais la définition :
\begin{equation*}
    a < b \equiv \succ a \leq b
\end{equation*}
...
\begin{equation*}
a \leq b \land \lnot (b \leq a) \implies succ a \leq b
\end{equation*}
