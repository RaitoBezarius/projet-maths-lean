...
\begin{minted}[mathescape,linenos,numbersep=5pt,frame=lines,framesep=2mm,breaklines]{lean}
Lemma : if P is true and $P \to Q$ is true, then Q is true.
\end{minted}
...
\\
\begin{minted}[mathescape,linenos,numbersep=5pt,frame=lines,framesep=2mm,breaklines]{lean}
Lemme : ($P to Q) to (lnot Q to lnot P)$. 
...
\\
\begin{minted}[mathescape,linenos,numbersep=5pt,frame=lines,framesep=2mm,breaklines]{lean}
Lemme : Soient P,Q et R trois propositions, alors $Pland(Q lor R) Longleftrightarrow (Pland Q) lor (P land R)$.
\end{minted}
