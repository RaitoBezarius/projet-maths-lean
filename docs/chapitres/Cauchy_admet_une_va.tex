...
\mintinline[escapeinside=||,mathescape]{lean}{lemma cauchy_admet_une_va |$(x : \mathbb{N} \to \mathbb{R}) : \texttt{cauchy} \, x \to \forall l_1 \, l_2: X,\, \texttt{adhere}\, x\, l_1 \land \texttt{adhere}\, x\, l_2 \to l_1 = l_2$|}\\
Pour cela, on a besoin d'une autre preuve, à savoir : \\
\mintinline[escapeinside=||,mathescape]{lean}{lemma eq_of_dist_lt |$(x\, y : X) : (\forall \varepsilon > 0,\, d\, x\, y < \varepsilon) \to x = y$| }\\
